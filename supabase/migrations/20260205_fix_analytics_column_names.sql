-- Corrección de nombres de columnas en funciones de estadísticas
-- Fecha: 2026-02-05
...
begin
  ...
  return query
    select
      ...
      end as country, -- Corregido de country_name a country
      count(*)::bigint as views,
      count(distinct visitor_hash)::bigint as unique_visitors
    from public.analytics_events
    where event_type = 'page_view'
...
begin
  ...
  return query
    select
      ...
      end as path, -- Corregido de clean_path a path
      count(*)::bigint as views,
      count(distinct visitor_hash)::bigint as unique_visitors
    from public.analytics_events
    where event_type = 'page_view'
